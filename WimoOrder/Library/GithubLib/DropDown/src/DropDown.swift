...
public final class DropDown: UIView {
	...
	*/
	...
	//MARK: Constraints
	fileprivate var dheightConstraint: NSLayoutConstraint!
	fileprivate var dwidthConstraint: NSLayoutConstraint!
...
extension DropDown {
	...
	public override func updateConstraints() {
		...
		dwidthConstraint.constant = layout.width
		dheightConstraint.constant = layout.visibleHeight
	...
	fileprivate func setupConstraints() {
		...
		dwidthConstraint = NSLayoutConstraint(
			item: tableViewContainer,
			attribute: .width,
			relatedBy: .equal,
			toItem: nil,
			...
			multiplier: 1,
			constant: 0)
		tableViewContainer.addConstraint(dwidthConstraint)

		dheightConstraint = NSLayoutConstraint(
			item: tableViewContainer,
			attribute: .height,
			relatedBy: .equal,
			toItem: nil,
			...
			multiplier: 1,
			constant: 0)
		tableViewContainer.addConstraint(dheightConstraint)
