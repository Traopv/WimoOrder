//
//  CircleFloatRatingView.swift
//  BVPS-DatKham
//
//  Created by trongpv93 on 6/4/19.
...
@IBDesignable
@objcMembers
open class CircleFloatRatingView: UIView {
...
//        let width   = self.frame.width
        ...
        let midFrame = CGRect(x: centerX, y: 0, width: imageViewSize.width, height: imageViewSize.height)
        let imageView = emptyImageViews[2]
        imageView.frame = midFrame
        imageView.center = CGPoint(x: centerX, y: 0)
        let imageViewFull = fullImageViews[2]
        imageViewFull.frame = midFrame
        imageViewFull.center = CGPoint(x: centerX, y: 0)
        
        let left1X = centerX - (height / 2) * sin(degree2radian(a: 30))
        let left1Y = centerY - (height / 2) * cos(degree2radian(a: 30))
        let left1Frame = CGRect(x: left1X, y: left1Y, width: imageViewSize.width, height: imageViewSize.height)
        
        let imgLeft1 =  emptyImageViews[1]
        imgLeft1.frame = left1Frame
        imgLeft1.center = CGPoint(x: left1X, y: left1Y)
        
        let imgLeft1Full =  fullImageViews[1]
        imgLeft1Full.frame = left1Frame
        imgLeft1Full.center = CGPoint(x: left1X, y: left1Y)
        
        
        let left2X = centerX - (height / 2) * sin(degree2radian(a: 2 * 30))
        let left2Y = centerY - (height / 2) * cos(degree2radian(a: 2 * 30))
        let left2Frame = CGRect(x: left2X, y: left2Y, width: imageViewSize.width, height: imageViewSize.height)
        
        let imgLeft2 =  emptyImageViews[0]
        imgLeft2.frame = left2Frame
        imgLeft2.center = CGPoint(x: left2X, y: left2Y)
        
        let imgLeft2Full =  fullImageViews[0]
        imgLeft2Full.frame = left2Frame
        imgLeft2Full.center = CGPoint(x: left2X, y: left2Y)
        
        let right1X = centerX + (height / 2) * sin(degree2radian(a: 30))
        let right1Y = centerY - (height / 2) * cos(degree2radian(a: 30))
        let right1Frame = CGRect(x: right1X, y: right1Y, width: imageViewSize.width, height: imageViewSize.height)
        
        let imgRight1 =  emptyImageViews[3]
        imgRight1.frame = right1Frame
        imgRight1.center = CGPoint(x: right1X, y: right1Y)
        
        let imgRight1Full =  fullImageViews[3]
        imgRight1Full.frame = right1Frame
        imgRight1Full.center = CGPoint(x: right1X, y: right1Y)
        
        
        let right2X = centerX + (height / 2) * sin(degree2radian(a: 2 * 30))
        let right2Y = centerY - (height / 2) * cos(degree2radian(a: 2 * 30))
        let right2Frame = CGRect(x: right2X, y: right2Y, width: imageViewSize.width, height: imageViewSize.height)
        
        let imgRight2 =  emptyImageViews[4]
        imgRight2.frame = right2Frame
        imgRight2.center = CGPoint(x: right2X, y: right2Y)
        
        let imgRight2Full =  fullImageViews[4]
        imgRight2Full.frame = right2Frame
        imgRight2Full.center = CGPoint(x: right2X, y: right2Y)
...
//            let imageFrame = CGRect(x: x, y: y, width: imageViewSize.width, height: imageViewSize.height)
//
//            var imageView = emptyImageViews[i]
//            imageView.frame = imageFrame
//            imageView.frame.origin.x = x - imageView.frame.midX
//            imageView.frame.origin.y = y - imageView.frame.midY
//
//            imageView = fullImageViews[i]
//            imageView.frame = imageFrame
//            imageView.frame.origin.x = x - imageView.frame.midX
